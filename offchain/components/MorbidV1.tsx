...
const MorbidV1 = (props: {
  ...
  const alwaysTrueToken1 = `${alwaysTruePolicy}${fromText("TokenAv1")}`;
  const alwaysTrueToken2 = `${alwaysTruePolicy}${fromText("TokenBv1")}`;
